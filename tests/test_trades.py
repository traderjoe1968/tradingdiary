...
# Test case classes
class TradesWithCancelTestCase(ReadXmlSnippetMixin, unittest.TestCase):
    stmt_sections = [
        (
            '<Trades>'

            '<Trade accountId="5678" acctAlias="Test account" model="" '
            'currency="USD" fxRateToBase="1" assetCategory="STK" '
            'symbol="CNVR.SPO" description="CONVERA CORPORATION - SPINOFF" '
            'conid="132118505" securityID="" securityIDType="" cusip="" '
            'isin="" underlyingConid="" underlyingSymbol="" issuer="" '
            'multiplier="1" strike="" expiry="" putCall="" '
            'principalAdjustFactor="" tradeID="" reportDate="2013-08-01" '
            'tradeDate="2011-05-09" tradeTime="000000" settleDateTarget="" '
            'transactionType="FracShare" exchange="--" quantity="-0.276942" '
            'tradePrice="0.00001" tradeMoney="-0.000002769" '
            'proceeds="0.000002769" taxes="0" ibCommission="0" '
            'ibCommissionCurrency="USD" netCash="0.000002769" '
            'closePrice="0.00001" openCloseIndicator="C" notes="" '
            'cost="-449.712074" fifoPnlRealized="-449.712071" fxPnl="0" '
            'mtmPnl="-0" origTradePrice="0" origTradeDate="" origTradeID="" '
            'origOrderID="0" clearingFirmID="" transactionID="3723709320" '
            'buySell="SELL" ibOrderID="3723709320" ibExecID="" '
            ...
            'isin="" underlyingConid="" underlyingSymbol="" issuer="" '
            'multiplier="1" strike="" expiry="" putCall="" '
            'principalAdjustFactor="" tradeID="" reportDate="2013-09-20" '
            'tradeDate="2011-05-09" tradeTime="000000" settleDateTarget="" '
            'transactionType="FracShareCancel" exchange="--" '
            'quantity="0.276942" tradePrice="0.00001" '
            'tradeMoney="0.000002769" proceeds="-0.000002769" taxes="0" '
            'ibCommission="0" ibCommissionCurrency="USD" '
            'netCash="-0.000002769" closePrice="0.00001" '
            'openCloseIndicator="" notes="Ca" cost="0.000002769" '
            'fifoPnlRealized="0" fxPnl="0" mtmPnl="0" origTradePrice="0" '
            'origTradeDate="" origTradeID="" origOrderID="0" '
            'clearingFirmID="" transactionID="3831648707" '
            'buySell="SELL (Ca.)" ibOrderID="3831648707" ibExecID="" '
            'brokerageOrderID="" orderReference="" volatilityOrderLink="" '
            'exchOrderId="N/A" extExecID="N/A" orderTime="" openDateTime="" '
            'holdingPeriodDateTime="" whenRealized="" whenReopened="" '
            'levelOfDetail="EXECUTION" changeInPrice="0" changeInQuantity="0" '
            ...
            'tradeDate="2011-05-09" tradeTime="000000" settleDateTarget="" '
            'transactionType="FracShare" exchange="--" quantity="-0.276942" '
            'tradePrice="203.698646" tradeMoney="-56.412710421" '
            'proceeds="56.412710421" taxes="0" ibCommission="0" '
            'ibCommissionCurrency="USD" netCash="56.412710421" '
            'closePrice="0.00001" openCloseIndicator="C" notes="" '
            'cost="-0.000003" fifoPnlRealized="56.412708" fxPnl="0" '
            'mtmPnl="56.4127" origTradePrice="0" origTradeDate="" '
            'origTradeID="" origOrderID="0" clearingFirmID="" '
            'transactionID="3831652905" buySell="SELL" ibOrderID="3831652905" '
            ...
            'isin="" underlyingConid="" underlyingSymbol="" issuer="" '
            'multiplier="1" strike="" expiry="" putCall="" '
            'principalAdjustFactor="" tradeID="" reportDate="2013-11-18" '
            'tradeDate="2011-05-09" tradeTime="000000" settleDateTarget="" '
            'transactionType="FracShareCancel" exchange="--" '
            'quantity="0.276942" tradePrice="203.698646" '
            'tradeMoney="56.412710421" proceeds="-56.412710421" taxes="0" '
            'ibCommission="0" ibCommissionCurrency="USD" '
            'netCash="-56.412710421" closePrice="0.00001" '
            'openCloseIndicator="" notes="Ca" cost="56.412710421" '
            'fifoPnlRealized="0" fxPnl="0" mtmPnl="-56.4127" '
            'origTradePrice="0" origTradeDate="" origTradeID="" '
            'origOrderID="0" clearingFirmID="" transactionID="3964505548" '
            'buySell="SELL (Ca.)" ibOrderID="3964505548" ibExecID="" '
            'brokerageOrderID="" orderReference="" volatilityOrderLink="" '
            'exchOrderId="N/A" extExecID="N/A" orderTime="" openDateTime="" '
            'holdingPeriodDateTime="" whenRealized="" whenReopened="" '
            'levelOfDetail="EXECUTION" changeInPrice="0" changeInQuantity="0" '
            ...
            'tradeDate="2011-05-09" tradeTime="000000" settleDateTarget="" '
            'transactionType="FracShare" exchange="--" quantity="-0.276942" '
            'tradePrice="5334.4" tradeMoney="-1477.3194048" '
            'proceeds="1477.3194048" taxes="0" ibCommission="0" '
            'ibCommissionCurrency="USD" netCash="1477.3194048" '
            'closePrice="0.00001" openCloseIndicator="C" notes="" '
            'cost="-56.41271" fifoPnlRealized="1420.906694" fxPnl="0" '
            'mtmPnl="1477.3194" origTradePrice="0" origTradeDate="" '
            'origTradeID="" origOrderID="0" clearingFirmID="" '
            'transactionID="3964508206" buySell="SELL" ibOrderID="3964508206" '
            'ibExecID="" brokerageOrderID="" orderReference="" '
            'volatilityOrderLink="" exchOrderId="N/A" extExecID="N/A" '
            'orderTime="" openDateTime="" holdingPeriodDateTime="" '
            'whenRealized="" whenReopened="" levelOfDetail="EXECUTION" '
...
class TradesIgnoreTestCase(ReadXmlSnippetMixin, unittest.TestCase):
    """
...
class TradesWithSortFieldTestCase(ReadXmlSnippetMixin, unittest.TestCase):
    stmt_sections = [
        """
        <Trades>
    ...
    def persisted_txs(self):
        return [
            Trade(
                ...
                security=self.securities[0],
                units=Decimal("-200"),
                sort=models.TransactionSort.MINGAIN,
            )
        ]
